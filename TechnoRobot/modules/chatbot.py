...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Techno Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get(f'https://kukiapi.xyz/api/apikey={KUKI_API}/yuzuki/moezill/message='+Message)
...
*Powered by [Shiv.Demon](https://t.me/Shivamdemon)*
"""
