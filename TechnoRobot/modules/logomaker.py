# Credit @saury12p || If You are Kang this Don't Remove Credits
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./TechnoRobot/resources/font/*")
    ...
    fname = "Techno.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Made by [𝚆𝙰𝚁𝚁𝙸𝙾𝚁𝙼𝚄𝚂𝙸𝙲](@warriormusic_bot)")         
    await pesan.delete()
